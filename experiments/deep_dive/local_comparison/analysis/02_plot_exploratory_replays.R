...
ggsave(paste0(plot_dir, '/learning_frac_over_time_facet.pdf'), width = 12, height = 10, units = 'in')
ggsave(paste0(plot_dir, '/learning_frac_over_time_facet.png'), width = 12, height = 10, units = 'in')
...
ggplot(df[df$is_learning == T & df$is_necessary_exploratory_replay,], aes(x=depth_frac, group = as.factor(true_seed))) + 
  ...
  labs(color = 'Classification') +
  labs(fill = 'Classification')
ggsave(paste0(plot_dir, '/learning_frac_over_time_norm_x.pdf'), width = 9, height = 6, units = 'in')
ggsave(paste0(plot_dir, '/learning_frac_over_time_norm_x.png'), width = 9, height = 6, units = 'in')
...
ggplot(df[df$is_learning == T & df$is_necessary_exploratory_replay,], aes(x=depth_frac, group = as.factor(true_seed))) + 
  ...
  labs(fill = 'Classification') + 
  facet_wrap(vars(true_seed)) 
ggsave(paste0(plot_dir, '/learning_frac_over_time_facet_norm_x.pdf'), width = 12, height = 10, units = 'in')
ggsave(paste0(plot_dir, '/learning_frac_over_time_facet_norm_x.png'), width = 12, height = 10, units = 'in')
