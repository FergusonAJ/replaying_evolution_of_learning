...
replay_plot_dir = paste0(plot_dir, 'exploratory_replays/')
create_dir_if_needed(replay_plot_dir)

# Learning frac over time
ggplot(df_replay_classification_summary[df_replay_classification_summary$is_learning == T,], aes(x=relative_depth, group = as.factor(seed))) + 
