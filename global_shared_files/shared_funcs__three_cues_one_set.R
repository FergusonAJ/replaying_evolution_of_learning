...
classify_individual_trials = function(df){
  ...
  df$doors_incorrect_3 = df$doors_taken_3 - df$doors_correct_3
  ...
  df$trial_classification[df$trial_classification == trial_class_none 
                          ...
                          & df$doors_incorrect_2 >= df$doors_correct_3 
                          & df$doors_incorrect_2 <= (df$doors_correct_3 + 1)
                          ] = trial_class_error_correction_naive_2
  df$trial_classification[df$trial_classification == trial_class_none 
                          & df$doors_incorrect_2 <= 1 
                          & df$doors_incorrect_3 >= df$doors_correct_2 
                          & df$doors_incorrect_3 <= (df$doors_correct_2 + 1)
...
classify_seeds = function(df){
  ...
  df_summary = dplyr::summarize(df_grouped, 
                                ...
                                (!!rlang::sym(trial_class_set_wrong)) := sum(!! rlang::sym(trial_class_set_wrong)),
                                ...
                                (!!rlang::sym(trial_class_error_correction_naive_3)) := sum(!! rlang::sym(trial_class_error_correction_naive_3)),
                                (!!rlang::sym(trial_class_error_correction_better_2)) := sum(!! rlang::sym(trial_class_error_correction_better_2)),
                                (!!rlang::sym(trial_class_error_correction_better_3)) := sum(!! rlang::sym(trial_class_error_correction_better_3)),
  ...
  df_summary$all_error_correction = df_summary$naive_error_correction_lead_2 + df_summary$naive_error_correction_lead_3 + df_summary$better_error_correction_lead_2 + df_summary$better_error_correction_lead_3 + df_summary$split_error_correction
  df_summary$all_failed = df_summary$trapped + df_summary$small + df_summary$set_wrong
  # Classify
